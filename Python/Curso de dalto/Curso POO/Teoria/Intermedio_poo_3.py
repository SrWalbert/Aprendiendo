...
class Persona:
    ...
    # el metodo especial __str__ sirve para que cuando el objeto sea mencionado, se describa como texto
    def __str__(self) -> str:
        return f"Persona(nombre={self.nombre}, edad={self.edad})"

    # __repr__ es como se va a representar el objeto
...
# Mostrando utilidad de __str__
sr_isaac = Persona("Isaac", 16)
print(sr_isaac)

# uso de __repr__
representacion = repr(sr_isaac)
resultado_pers = eval(representacion)
print(resultado_pers)

"Sobrecarga de operadores"
# utilidad de __add__
pedro = Persona("Pedro", 17)
add_resultado = sr_isaac + pedro
print(add_resultado)
# Acabamos de definir como se comportan los objetos de la clase Persona ante las sumas

"Otros metodos especiales (dunner)"
