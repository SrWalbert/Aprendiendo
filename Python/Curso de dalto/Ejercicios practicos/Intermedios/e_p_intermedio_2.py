...
def es_primo(num):
    # Verificamos que ese numero no se puede dividir en entero entre de ni ese mismo numero menos uno (solo se divide por sí mismo y uno)
